...
class ReportRendererTests(unittest.TestCase):
    ...
    def test_report_footer_is_sticky_and_local_only(self):
        report = {
        ...
        self.assertIn(
            '<div class="stamp-sub">transcripts were not uploaded</div>',
            page,
        )
        self.assertIn(".report-footer { position: sticky; bottom: 16px;", page)
        self.assertIn(
            "Generated August 25, 2026 at 12:00 AM UTC &middot; harness: pi",
            page,
        )
    ...
    def test_share_card_uses_skill_doctor_attribution(self):
        ...
        self.assertIn(
            '"stamp": ["Get your report with /skill:skill-doctor", '
            '"local HTML report"]',
            page,
        )
    ...
    def test_skill_output_uses_local_report_labels(self):
        ...
        self.assertIn("Pi has no user-question tool", skill_text)
